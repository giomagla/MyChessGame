...
public class Knight extends Piece{
    public Knight(PieceTypes type, String color,String imagePath) {
    ...
    public boolean move(Piece[][] board, String color, int row, int col, int desiredRow, int desiredCol) {
        ...
        if (isValidMove) {
            System.out.println("Move is valid: Moving Knight to (" + desiredRow + ", " + desiredCol + ")");
            ...
            System.out.println("Invalid move: Cannot move Knight to (" + desiredRow + ", " + desiredCol + ")");
        }
        return isValidMove;
    }
    ...
    public List<int[]> validMoves(Piece[][] board, String color, int row, int col) {
        ...
        int[][] directions = {
                {-2, 1},  // two up and right
                {-2,-1},  // two up  and left
                { 2,-1},  // two down and left
                { 2, 1},  // two  down and right
                { 1,-2},  // up and two left
                {-1,-2},  // down and two left
                { 1, 2},  // up and two right
                {-1, 2}   // down and two right
        };
