...
public class Rook extends Piece{
    public Rook(PieceTypes type, String color, String imagePath) {
    ...
    public boolean move(Piece[][] board, String color, int row, int col, int desiredRow, int desiredCol) {
        ...
        if (isValidMove) {
            System.out.println("Move is valid: Moving Rook to (" + desiredRow + ", " + desiredCol + ")");
            ...
            System.out.println("Invalid move: Cannot move Rook to (" + desiredRow + ", " + desiredCol + ")");
        }
        return isValidMove;
    }
