...
public class Bishop extends Piece {
    ...
    public Bishop(PieceTypes type, String color, String imagePath) {
    ...
    public boolean move(Piece[][] board, String color, int row, int col, int desiredRow, int desiredCol) {
        ...
        if (isValidMove) {
            System.out.println("Move is valid: Moving Bishop to (" + desiredRow + ", " + desiredCol + ")");
            ...
            System.out.println("Invalid move: Cannot move Bishop to (" + desiredRow + ", " + desiredCol + ")");
        }
        return isValidMove;
    }
